...
class ComponentTools {
    ...
    async autoBindComponent(a) {
        ...
        const flatten = (node) => {
            ...
            if (!node)
                return;
            const uuid = typeof node.uuid === 'string' ? node.uuid : (_a = node.uuid) === null || _a === void 0 ? void 0 : _a.value;
            const name = typeof node.name === 'string' ? node.name : (_b = node.name) === null || _b === void 0 ? void 0 : _b.value;
            if (uuid && name) {
                sceneNodes.push({ uuid, name });
            }
            for (const child of (_c = node.children) !== null && _c !== void 0 ? _c : []) {
                flatten(child);
            }
        };
        flatten(tree);
