...
exports.methods = {
    ...
    async changePreviewPlayState(state) {
        var _a, _b;
        try {
            const sceneFacade = (_a = globalThis.cce) === null || _a === void 0 ? void 0 : _a.SceneFacade;
            if (!sceneFacade) {
                return {
                    success: false,
