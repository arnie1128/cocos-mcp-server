...
| 版本 | 主題 | 估時 | bump | 狀態 |
|---|---|---|---|---|
| v2.3.0 | AI workflow 強化（execute_javascript + screenshot + docs markdown） | 2 天 | minor | ⏳ next |
| v2.4.0 | 6-step 架構重構（含 InstanceReference + TS 定義生成 + decorator） | 4 天 | minor | ⏳ |
| v2.4.1 | Asset interpreters 系統（asset meta 編輯能力） | 2-3 天 | patch | ⏳ |
