# v2.4 Release Notes Archive

Large tooling expansion and stabilization cycle: declarative tool registration, inspector/assetMeta/animation tools, diagnostics, and live-test review fixes.
