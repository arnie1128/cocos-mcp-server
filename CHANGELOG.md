...
Three-way cumulative review round-3 patch: fixed `check_editor_health` empty-array boundary and wrapped v2.9.x after 3 rounds + 1 follow-up.
Full v2.9.x release notes: [`docs/releases/v2.9.md`](docs/releases/v2.9.md).

## v2.9.6 — 2026-05-02

Cumulative review round-2 patch: fixed MediaRecorder regex attempt 1, unverified scene channel, null-healthy guard, SERVER_VERSION minor-base drift, record_stop cap text, and `_recState` ordering.
Full v2.9.x release notes: [`docs/releases/v2.9.md`](docs/releases/v2.9.md).

## v2.9.5 — 2026-05-02

Cumulative review round-1 patch: health probe, recording persistence, cleanup/duration, cap reconciliation, path/root boundary, referenceImage array validation, and handoff cleanup.
Full v2.9.x release notes: [`docs/releases/v2.9.md`](docs/releases/v2.9.md).

## v2.9.4 — 2026-05-02

T-V29-5 MediaRecorder bridge: `debug_record_start` / `debug_record_stop`, client record handlers, and server-side recording persistence guardrails.
Full v2.9.x release notes: [`docs/releases/v2.9.md`](docs/releases/v2.9.md).

## v2.9.3 — 2026-05-02

T-V29-6 macro-tool routing collapsed 12 referenceImage tools into `referenceImage_manage({op,...})` and parked risky preview-mode tools behind explicit gates.
Full v2.9.x release notes: [`docs/releases/v2.9.md`](docs/releases/v2.9.md).

## v2.9.2 — 2026-05-02

Polish batch closed the deferred v2.8.1 single-reviewer items: CORS/Vary consistency, path containment, preview in-flight guard, diagnostics refactor, scene methods alignment, warning symmetry, and TOCTOU docs.
Full v2.9.x release notes: [`docs/releases/v2.9.md`](docs/releases/v2.9.md).

## v2.9.1 — 2026-05-02

Live-test fix documented `debug_set_preview_mode` silent no-op and preview freeze probe gap as landmines #16/#17; setter remains experimental.
Full v2.9.x release notes: [`docs/releases/v2.9.md`](docs/releases/v2.9.md).

## v2.9.0 — 2026-05-02

Added `debug_check_editor_health` and `debug_set_preview_mode`, raising the line to 18 categories / 190 tools before later macro-tool consolidation.
Full v2.9.x release notes: [`docs/releases/v2.9.md`](docs/releases/v2.9.md).

## v2.8.4 — 2026-05-02

Browser-mode retest broadened landmine #16 to all preview modes and made capture fallback hints mode-aware.
Full v2.8.x release notes: [`docs/releases/v2.8.md`](docs/releases/v2.8.md).

## v2.8.3 — 2026-05-02

Embedded-mode PIE/capture follow-up added preview-mode detection and documented the `softReloadScene` freeze race with recovery guidance.
Full v2.8.x release notes: [`docs/releases/v2.8.md`](docs/releases/v2.8.md).

## v2.8.2 — 2026-05-02

Reload retest fixed runtime-only `SceneFacadeManager` lookup and relative savePath anchoring to project root.
Full v2.8.x release notes: [`docs/releases/v2.8.md`](docs/releases/v2.8.md).

## v2.8.1 — 2026-05-02

Three-way review patch for v2.8.0: containment helper anchor, SERVER_VERSION sync, explicit savePath guards, contribution methods, Origin array guard, and HANDOFF SHA fix.
Full v2.8.x release notes: [`docs/releases/v2.8.md`](docs/releases/v2.8.md).

## v2.8.0 — 2026-05-02

Spillover release delivered CORS hoist/Vary, shared capture-path realpath helper, and `debug_preview_control` through `changePreviewPlayState`.
Full v2.8.x release notes: [`docs/releases/v2.8.md`](docs/releases/v2.8.md).

## v2.7.3 — 2026-05-02

Codex re-attendance patch fixed stale HANDOFF body/candidate text and locked two polish items; round 3 reached three-way ship-it.
Full v2.7.x release notes: [`docs/releases/v2.7.md`](docs/releases/v2.7.md).

## v2.7.2 — 2026-05-02

Round-2 doc patch corrected CLAUDE.md architecture-map drift and HANDOFF heading state after v2.7.1.
Full v2.7.x release notes: [`docs/releases/v2.7.md`](docs/releases/v2.7.md).

## v2.7.1 — 2026-05-02

Round-1 review patch fixed CORS doc/code mismatch, CHANGELOG channel wording, smoke preflight coverage, IPv6 localhost normalization, and related polish.
Full v2.7.x release notes: [`docs/releases/v2.7.md`](docs/releases/v2.7.md).

## v2.7.0 — 2026-05-02

Preview-QA + security hardening: closed reflect-metadata cleanup, scoped `/game/*` CORS, added preview URL/device tools, and added capture preview screenshot.
Full v2.7.x release notes: [`docs/releases/v2.7.md`](docs/releases/v2.7.md).
## v2.6.2 — 2026-05-02
