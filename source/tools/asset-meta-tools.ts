    ...
    @mcpTool({
        ...
        inputSchema: assetTargetSchema.extend({
            properties: z.array(z.object({
                propertyPath: z.string().describe('Dotted meta path. Allowed roots: userData.*, subMetas.*, platformSettings.*, importer, importerVersion, sourceUuid, isGroup, folder.'),
                propertyType: z.string().describe('Type tag for value coercion: Boolean, Number, Float, Integer, String, Enum, cc.ValueType, cc.Object.'),
